...
<head>
    <title>Signup</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/user/user.signup.css">
</head>
<body>
    ...
    <form method="post" action="${pageContext.request.contextPath}/signup">
        <div class="form-header">
            ...
            <div class="form-input-password">
                ...
                <input class="input" type="password" id="confirmPassword" placeholder="Enter your password" name="confirmPassword">
            </div>
            <button class="signup" type="submit">Signup</button>
            <h3>Already have an account?  <a href="${pageContext.request.contextPath}/login" class="login">Login</a></h3>
        </div>
    </form>
</div>
